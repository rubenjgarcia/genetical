...
function Genetical(options) {
    ...
    this.evolve = function () {
        ...
        if (_.indexOf([Genetical.ROULETTEWHEELSELECTION, Genetical.STOCHASTICUNIVERSALSAMPLING, Genetical.RANK, Genetical.TOURNAMENT], this.selectionStrategy) === -1) {
        ...
        switch (this.selectionStrategy) {
            ...
            case Genetical.TOURNAMENT:
                if (!this.selectionStrategyOptions.tournamentSelection || _.isNaN(this.selectionStrategyOptions.tournamentSelection) || this.selectionStrategyOptions.tournamentSelection <= 0.5) {
                    throw "'selectionStrategyOptions.tournamentSelection' must be defined and must be a greater than 0.5"
                }
                newPopulation = this.tournamentSelection();
                break;
        }
